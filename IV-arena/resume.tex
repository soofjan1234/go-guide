...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item 掌握 Go 并发编程与源码机制，熟悉 channel、slice、map等组件的实现原理，理解defer、select、锁及 context 等核心特性。
    ...
    \begin{itemize}
        ...
        \item 了解 AI Agent 相关技术栈，包括 Transformer、Decoder-Only 架构、智能体范式、LangChain 与 LangGraph
    \end{itemize}
