...
description: >-
  面试录音复盘全流程：Whisper 转录 → 只改错字/术语误识别并整理问答 txt → 提取已问问题清单，不生成关键词或延伸问题。
...
## Step 3: 已问问题清单 iv{N}.md

从问答 txt 提取**面试官已经问过的问题**，不基于本轮内容扩展、预测或生成可能追问。
...
- 只提取 txt 中真实出现过的面试官问题；不要补充、联想、预测或扩展未被问到的问题
...
| `编写 iv2.md` | Step 3：只提取已问问题清单（需已有问答 txt） |
